/**
 * Script to run WOD endpoint tests with proper server management
 */
...
function runTests() {
    console.log('\nRunning WOD endpoint tests...');

    const testProcess = spawn('npx', ['ts-node', '-P', 'scripts/tsconfig.json', 'scripts/test/wod-endpoint.ts'], {
        stdio: 'inherit',
        shell: true
    });
